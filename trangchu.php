	    ...
	    <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu.php?mod=duan" tabindex="-1">
	                        Dự án hiện có
	                    </a>
	                </li>
	                <li>
	     ...
	     <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu.php?mod=bangcongviec" tabindex="-1">
	                        Bảng công việc
	                    </a>
	                </li>
	            </ul>
	     ...
	     <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu.php?mod=canhan" tabindex="-1">
	                        Quản lý cá nhân
	                    </a>
	                </li>
	            </ul>
					...
					<div id="maincontent">
						...
						<div class="right">
							<table class="table-right">
								<tr>
									<td class="menu"><a href="#">Danh sách công việc</a></td>
								</tr>
								<tr>
									<td height="200px;"><?php include"mod_right.php"; ?></td>
								</tr>
							</table>
						</div>
					</div>
