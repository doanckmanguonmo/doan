	    ...
	    <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu_thanhvien.php?mod=duan_tg" tabindex="-1">
	                        Danh sách dự án
	                    </a>
	                </li>
	            </ul>
	     ...
	     <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu_thanhvien.php?mod=bangcongviec" tabindex="-1">
	                        Bảng công việc
	                    </a>
	                </li>
	            </ul>
	     ...
	     <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu_thanhvien.php?mod=canhan" tabindex="-1">
	                        Quản lý cá nhân
	                    </a>
	                </li>
	            </ul>
