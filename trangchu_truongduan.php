	    ...
	    <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu_truongduan.php?mod=duan" tabindex="-1">
	                        Quản lý dự án
	                    </a>
	                </li>
	            </ul>
	     ...
	     <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu_truongduan.php?mod=bangcongviec" tabindex="-1">
	                        Bảng công việc
	                    </a>
	                </li>
	                <li>
	                    <a href="trangchu_truongduan.php?mod=quanlycongviec1" tabindex="-1">
	                        Quản lý công việc
	                    </a>
	                </li>
	            </ul>
	     ...
	     <ul class="nav sidebar-nav">
	        <li class="dropdown">
	            ...
	            <ul class="dropdown-menu">
	                <li>
	                    <a href="trangchu_truongduan.php?mod=canhan" tabindex="-1">
	                        Quản lý cá nhân
	                    </a>
	                </li>
	            </ul>
